...
import com.lixiangsoft.lixiang.music_player.MyApplication;
import com.lixiangsoft.lixiang.music_player.PlayService;
...
public class MediaSessionManager {
    ...
    public void updateMetaData(Music music) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            metaData.putLong(MediaMetadataCompat.METADATA_KEY_NUM_TRACKS, MyApplication.getMusicListNow().size());
        }
