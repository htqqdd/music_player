...
public class MyConstant {
    ...
    public static final int previousAction = 11;
    ...
    public static final int random_playAction = 23;
    //playMode 0:列表重复 1:随机 2:单曲重复 3:顺序
    public static final int list_repeat = 0;
    public static final int random = 1;
    public static final int one_repeat = 2;
    public static final int list = 3;
    public static final int reload = 22;
    public static final String Rec_one = "REC_ONE";
    public static final String Rec_two = "REC_TWO";
    public static final String Rec_all = "REC_ALL";
    public static final String list_all = "LIST_ALL";
    public static final String Playlist_all = "PLAYLIST_ALL";
    public static final String Detaillist_only = "DETAILLIST_ONLY";
}
